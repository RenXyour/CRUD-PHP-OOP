...
class Gudang {
    ...
    public function update() {
        $query = "UPDATE " . $this->table_name . " SET name = :name, location = :location, capacity = :capacity, 
                  status = :status, opening_hour = :opening_hour, closing_hour = :closing_hour WHERE id = :id";
  ...
  public function readPaginated($start, $limit) {
    ...
    $stmt->execute();
    return $stmt; // Pastikan ini adalah objek PDOStatement
    }
}
?>
